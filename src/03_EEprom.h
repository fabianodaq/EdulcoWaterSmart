...
#define SENS_3_TYPE     (SENS_2_CAL_Y2  +  INT_BYTES_SIZE)                   // (82)
#define SENS_3_CAL_X1   (SENS_3_TYPE    +  CHAR_BYTES_SIZE)                  // (83..84)
#define SENS_3_CAL_Y1   (SENS_3_CAL_X1  +  INT_BYTES_SIZE)                   // (85..86)
#define SENS_3_CAL_X2   (SENS_3_CAL_Y1  +  INT_BYTES_SIZE)                   // (87..88)
#define SENS_3_CAL_Y2   (SENS_3_CAL_X2  +  INT_BYTES_SIZE)                   // (89..90)

#define SENS_4_TYPE     (SENS_3_CAL_Y2  +  INT_BYTES_SIZE)                   // (91)
#define SENS_4_CAL_X1   (SENS_4_TYPE    +  CHAR_BYTES_SIZE)                  // (92..93)
#define SENS_4_CAL_Y1   (SENS_4_CAL_X1  +  INT_BYTES_SIZE)                   // (94..95)
#define SENS_4_CAL_X2   (SENS_4_CAL_Y1  +  INT_BYTES_SIZE)                   // (96..97)
#define SENS_4_CAL_Y2   (SENS_4_CAL_X2  +  INT_BYTES_SIZE)                   // (98..99)

#define EEPROM_INIT_FLAG_SENS_ADDR      (SENS_4_CAL_Y2  +  INT_BYTES_SIZE)          // (100)
#define EEPROM_INIT_SENS_FLAG                0xA5                           // init flag value
#define EEPROM_INIT_FLAG_SENS_NEG_ADDR  (EEPROM_INIT_FLAG_SENS_ADDR + FLAG_SIZE)    // (101)
